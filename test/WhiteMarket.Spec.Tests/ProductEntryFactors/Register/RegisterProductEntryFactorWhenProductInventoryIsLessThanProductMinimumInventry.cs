...
{
    [Scenario("ورود کالا زمانی که موجودی کالا از حداقل موجودی کالا کمتر میشود")]
    public class RegisterProductEntryFactorWhenProductInventoryIsLessThanProductMinimumInventry : BusinessIntegrationTest
    {
        ...
        public RegisterProductEntryFactorWhenProductInventoryIsLessThanProductMinimumInventry()
        {
            var _dateTime = new Mock<ProductEntryFactorDateTime>();
            _dateTime.Setup(_ => _.Generate()).Returns(DateTime.Now);
            _date = _dateTime.Object.Generate();
            _sut = ProductEntryFactorAppServiceFactory.Generate(SetupContext,_dateTime.Object);
        }
        ...
        [When("تعداد ۵  تا   از کالایی با عنوان شامپو " +
        ...
        public void Then()
        {
            ...
            expectedProduct.Inventory.Should().Be(5);
            ...
            expectedProductEntryFactor.Date.Should().Be(_date);
        }
